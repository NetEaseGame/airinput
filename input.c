...
void tap(int x, int y, int msec){
	int loop_times = 1;
	execute_tap(fd, device_flags, x, y, loop_times, msec);
}

void drag(int start_x, int start_y, int end_x, int end_y, int num_steps, int msec){
	execute_drag(fd, device_flags,
		start_x, start_y, end_x, end_y, num_steps, msec);
}

void pinch(int Ax0, int Ay0, int Ax1, int Ay1,
		int Bx0, int By0, int Bx1, int By1, int num_steps, int msec){
	execute_pinch(fd, device_flags, Ax0, Ay0, Ax1, Ay1,
			Bx0, By0, Bx1, By1, num_steps, msec);
}
